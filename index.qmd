...
**The Nature checklist is available [here](docs/nr-software-policy.pdf).**
...
Use the token `arepcamenvafhuz` to access the GEO entry private page during review.  

## Source code  {-}

- Source code for sequencind data processing is provided in [01.Processing.qmd](01.Processing.qmd);
...
### Software dependencies, OSes and versions {-}

Softwares and versions used during this project are listed in [00.System-requirements.qmd](00.System-requirements.qmd);
